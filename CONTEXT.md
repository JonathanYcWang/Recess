...
Recess helps people sustain a declared period of work by adaptively alternating focused effort and earned recovery while controlling access to distracting websites during focus time.
...
**Recess**:
An earned recovery interval after a completed Focus Block, except when the Work Session ends. Its duration is chosen by the Scheduler after the Reward Game resolves.
...
The ten-second transition interval between a Recess and the next Focus Block.

## Access and rewards

**Block List**:
The user-defined collection of websites whose access Recess controls during focus time. Native-application blocking is unsupported in v1.
...
**Task Planner**:
The service that recommends and sequences Tasks within a Work Session from manual Task List order. It does not choose Focus Block or Recess timing.

## Motivation and progression

**Coin**:
Recess’s spendable currency. Coins are earned from focused duration, qualifying Work Session Streak advancements, Focus Block Streak milestones, and spent on Hall Passes, paid Reward Game rerolls, Pet mood boosts, and cosmetics.
...
**Onboarding Quiz**:
The brief required questionnaire that seeds initial Workstyle Profile defaults.

**Personalization Quiz**:
The optional deeper assessment that enriches the Workstyle Profile and assigns the user’s Pet once.
...
**Scheduler**:
The pure decision service that determines Focus Block and Recess durations from preferred cadence, Energy, Momentum, Work Session progress, Task remaining work, exact remaining time, and Reward Game budget. Task recommendation and sequencing belong to the Task Planner.

## Work start scheduling

**Work Start Reminder**:
A weekly local-wall-time schedule that prompts the user to start work. It does not pre-create a Work Session; a start within fifteen minutes after a qualifying occurrence advances the Work Session Streak.
