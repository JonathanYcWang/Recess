 ...
 */
export function calculateMBTI(choices: QuizOption[]): string {
 ...
 */
export function calculateDominantFriction(choices: QuizOption[]): FrictionSignal[] {
 ...
 */
export function calculateQuizResults(choices: QuizOption[]): QuizResults {
  return {
