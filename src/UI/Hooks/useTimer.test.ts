...
import { setBlockedSites } from '../Redux/actions/blockedSitesActions';
import {
  endSessionEarly,
  endWorkSessionEarly,
  pauseSession,
...
import blockedSitesReducer from '../Redux/reducers/blockedSitesReducer';
import blockListProjectionReducer from '../Redux/reducers/blockListProjectionReducer';
import workstyleProfileProjectionReducer from '../Redux/reducers/workstyleProfileProjectionReducer';
import workRhythmProjectionReducer from '../Redux/reducers/workRhythmProjectionReducer';
import hallPassProjectionReducer from '../Redux/reducers/hallPassProjectionReducer';
import workStartReminderProjectionReducer from '../Redux/reducers/workStartReminderProjectionReducer';
import taskListProjectionReducer from '../Redux/reducers/taskListProjectionReducer';
import quizReducer from '../Redux/reducers/quizReducer';
import routingReducer from '../Redux/reducers/routingReducer';
import settingsProjectionReducer from '../Redux/reducers/settingsProjectionReducer';
...
const createState = (overrides: Partial<RootState['timer']> = {}): RootState => ({
  ...
  workStartReminderProjection: workStartReminderProjectionReducer(undefined, { type: 'test/init' }),
